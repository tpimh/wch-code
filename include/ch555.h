...
// define NO_XSFR_DEFINE before include CH555.H to disable xSFR define xdata address by _at_
...
//  RS485EN = bUH1_DISABLE & ~ bALE_CLK_EN
//   x00: disable RXD1/TXD1
//   010: RXD1/TXD1 connect P2.6/P2.7
//   001: disable RXD1/TXD1
//   011: RXD1/TXD1/TNOW connect P2.6/P2.7/P2.5
//   110: RXD1/TXD1 connect iRS485 pins XA/XB
//   101: RXD1/TXD1 connect iRS485 pins XA/XB, disable TNOW
...
#define bMCR_RTS          0x02      // UART1 control RTS, not real pin
#define bMCR_DTR          0x01      // UART1 control DTR, not real pin
...
#define DATA_FLASH_ADDR   0xE000    // start address of Data-Flash
